...
import { animateValue } from "@/utils/helpers";
import useIntersectionObserver from "@/hooks/useIntersectionObserver";
import EnhancedTerminal from "../ui/EnhancedTerminal";
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-12 items-center">
          ...
          <div className="space-y-4 text-gray-700 dark:text-gray-300">
            ...
            <p className="text-lg leading-relaxed">
              ...
              , learning containerization with Docker and Kubernetes,
              implementing CI/CD pipelines with Jenkins and GitHub Actions, and
            ...
            <p className="text-lg leading-relaxed">
              ...
              , cloud infrastructure, and building scalable systems. My goal is
              to bridge the gap between development and operations, creating
              efficient deployment pipelines and robust infrastructure.
            </p>
          </div>
          {/* Stats Section (50%) */}
          <motion.div
              ...
              {animatedStats.map((stat, index) => (
                <motion.div
                  ...
                  className="p-6 bg-gradient-to-br from-primary/10 to-secondary/10 
                     ...
                     dark:border-primary/30 text-center"
                >
                  <div className="text-4xl md:text-5xl font-bold gradient-text mb-2">
                    {stat.currentValue}
                    {stat.suffix}
